...
public class NotificacionPagoDTO {
    ...
    private String transactionAmountMP;
    ...
    public String getTransactionAmountMP() { return transactionAmountMP; }
    public void setTransactionAmountMP(String transactionAmountMP) { this.transactionAmountMP = transactionAmountMP; }
}
